...
/**
 * Summary of conn_mysql
 * @return void
 */
function conn_mysql(){
    global $conn;
    
    //éléments de connexion à la base de donnée SQL via phpmyadmin
        $servername = '';
        $username= '';
        $password= '';
    ...
    //On établit la connexion
        $conn= new mysqli($servername,$username,$password, ' '); //remplacer ' ' par nom de la base de données
        
    //On assure la connexion 
        if($conn->connect_error){
            die('Erreur: ' .$conn->connect_error);
        }
        
    //Test pour voir si la connexion est bien réussie
