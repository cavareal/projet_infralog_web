...
<?php //include ("core_connection.php"); ?>
    ...
    <div class="card-img-overlay">
        ...
        <?php
           if (isset($_GET['form']) && $_GET['form'] == 'connexion') {
            //Demande les informations de connexion (pour utilisateurs déjà inscrit)
                echo'<div class="card my-5" id="carte">
                    ...
                    <div class="card-body">
                        <form class="conn" action="core.php" method="POST">
                            ...
                            <input type="submit" class="btn text-white" id="couleur_logo" name="connecter" value="Se connecter">
                        </form>
                        <br><p> Vous n\'êtes pas encore inscrit ? <a href="?form=inscription"> Créez vous un compte </a></p>
                    </div>
                </div>';   
            }else{
                ...
                <div class="card-body">
                    <form class="inscription" action="core.php" method="POST">
                        ...
                        <div class="form-floating mb-3 mt-3">
                            <input type="text" class="form-control" name="prenom_inscri" placeholder="Prenom" required>
                        ...
                        <div class="form-floating mb-3 mt-3">
                            <input type="text" class="form-control" name="email_inscri" placeholder="Email" required>
                            <label for="email_inscri">Email</label>
                        </div>
                        <div class="form-floating mb-3 mt-3">
                            <input type="password" class="form-control" name="motdepasse_inscri" placeholder="Mot de passe" required>
                            <label for="motdepasse_inscri">Mot de passe</label>
                        </div>
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="checkbox" name="condition" required>
                            <label class="form-check-label" for="condition">En cochant cette case, j\'accepte les conditions d\'utilisation de FlyBook\'ESEO</label>
                            <div class="invalid-feedback">Vous devez cocher cette case pour continuer</div>
                        </div>
                        <input type="submit" class="btn text-white" id="couleur_logo" name="inscrire" value="S\'inscrire">
                    </form>
                    <br><p> Vous avez déjà un compte ? <a href="?form=connexion"> Connectez-vous</a></p>
                </div>
            </div>';
            }
            ?>
